...
if ~strcmp(stimulus_str_in,stimulus_str_out) || ~strcmp(spikes_str_in,spikes_str_out) || ...
        ...
        ~strcmp(spike_realtime_str_in,spike_realtime_str_out) || ~strcmp(spike_future_str_in,spike_future_str_out) || ...
    ...
    if ~isempty(spike_future_str_out)
        set(handles.subplot_spike_future_posi_edit,'String',spike_future_str_out)
    else
        set(handles.subplot_spike_future_posi_edit,'String',f_para.subplot_posi(6))
    end
