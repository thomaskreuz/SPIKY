...
set(handles.dpara_dsf_edit,'String',num2str(d_para.dsf),'Enable','on')
...
set(handles.subplot_spike_future_posi_edit,'String',num2str(f_para.subplot_posi(7)))
...
set(handles.fpara_subplot_size_edit,'String',regexprep(num2str(f_para.subplot_size),'\s+',' '))
