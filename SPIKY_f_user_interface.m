...
d_para_default=struct('tmin',[],'tmax',[],'dts',[],'max_total_spikes',100000,'max_memo_init',20000000,'num_trains',[],...
    ...
    'comment_string','SPIKY','example',1);
...
f_para_default=struct('imagespath',['.',filesep],'moviespath',['.',filesep],...    % Default values
    ...
    'profile_norm_mode',1,'profile_average_line',0,'color_norm_mode',1,'colorbar',1,'group_matrices',0,'dendrograms',0,...   % profile_norm_mode=4 only one tic? ###
    'histogram',0,'spike_train_color_coding_mode',1,'spike_col',2,'subplot_size',[],'plot_mode',5,...
    'subplot_posi',[0 1  0  2    0 0 0]);
