...
set(handles.Generate_pushbutton,'TooltipString',sprintf('One of three ways to select data.\n Loads the example selected in the listbox.\n Once the spike trains are created the ‘Parameters: Data’ panel is activated.'))
set(handles.Generator_pushbutton,'TooltipString',sprintf('Another of the three ways to select data.\n Starts spike train generator in a new window.\n Once the spike trains are created the ‘Parameters: Data’ panel is activated.'))
%
% #########################################################################
...
set(handles.dpara_dsf_edit,'TooltipString',sprintf('Factor (positive integer) which defines the downsampling of the measure profiles.'))
...
set(handles.subplot_spike_future_posi_edit,'TooltipString',sprintf('This selects the future variant of the SPIKE-distance with a piecewise constant dissimilarity profile. The instantaneous values rely on future information only which can be useful for triggered averages in order to evaluate the causal effect of certain external (stimulus) or internal (spikes) features on the future spiking. For a description of this spike train distance refer to the third paper cited at the end.'))
set(handles.subplot_spike_future_posi_text,'TooltipString',get(handles.subplot_spike_future_posi_edit,'TooltipString'))
%
% ######################################
...
set(handles.Movie_beginning_pushbutton,'TooltipString',sprintf('Immediate jump to the beginning of the movie'))
set(handles.Movie_run_pushbutton,'TooltipString',sprintf('This starts the movie from its current position with the speed defined below (see subpanel ‘Speed’)\n and in the direction defined below (see subpanel ‘Direction’).'))
set(handles.Movie_stop_pushbutton,'TooltipString',sprintf('This stops the movie at its current position.'))
set(handles.Movie_end_pushbutton,'TooltipString',sprintf('Immediate jump to the end of the movie'))
