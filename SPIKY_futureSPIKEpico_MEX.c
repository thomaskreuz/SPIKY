/*
 * Future SPIKE-distance (only known spikes are ones that follow) (Kreuz) picewise constant
 */
...

{
    ...
    float *bi_spike_diffs_future_t, *cum_isi, *foll_spikes, *isi, *udists, *udists2;
    ...
    mxSetN(bi_spike_diffs_future_t_out, *run_pico_lengths_ruc);
    mxSetData(bi_spike_diffs_future_t_out, mxMalloc(sizeof(float) * *num_pairs * *run_pico_lengths_ruc));
