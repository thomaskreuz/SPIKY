...

{
    ...
    int *num_pairs, *run_time_lengths_ruc, *num_trains, *foll_indy, pac = 0, sac, trac1, trac2, M;
    ...
    mxSetData(bi_spike_diffs_future_t_out, mxMalloc(sizeof(float) * *num_pairs * *run_time_lengths_ruc));
